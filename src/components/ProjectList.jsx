...
const ProjectData = [
  ...
  },
  {
    ...
    name: "VIChatify",
    disc: "Implemented Real time Group and Personal Chatting, Video call features.",
  ...
  {
    imgsrc: "https://i.postimg.cc/9frDccy4/Screenshot-386.png",
    name: "EDashboard",
    disc: "Implemented user interface for User managementand Data visualization.",
    techStack: ["Nivo Charts", "Reactjs", "NodeJs", "ExpressJs", "MongoDB"],
    wevsiteUrl: "https://dashboard-x1h2.onrender.com/",
    gitHubUrl: "https://github.com/RaviSKumar210755/EDashboard",
  },
  {
    imgsrc: "https://i.postimg.cc/SKCdx32k/Screenshot-389.png",
    name: "Commute Planner App",
    disc: "Users can explore nearby houses, route insights, annual travel costs.",
    techStack: ["Reactjs", "NodeJs", "MongoDB", "OpenStreetMaps"],
    wevsiteUrl: "https://commute-planner.vercel.app/",
    gitHubUrl: "https://github.com/RaviSKumar210755/EDashboard",
  },
  {
    imgsrc: "https://i.postimg.cc/jSQ479QX/Screenshot-390.png",
    name: "Movie App",
    disc: "Users can explore latest movies with searching feature.",
    techStack: ["Nextjs", "Tailwind CSS", "TMDB API"],
    wevsiteUrl: "https://imdb.100jsprojects.com/",
    gitHubUrl: "https://github.com/RaviSKumar210755/Movie-App",
  },
  {
    imgsrc: "Covid.png",
    name: "Covid 19",
